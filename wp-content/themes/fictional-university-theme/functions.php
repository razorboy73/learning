...
function university_files(){
    ...
    wp_enqueue_script('googleMap', "//maps.googleapis.com/maps/api/js?key=AIzaSyCanSBlOFWxNbdr3dtMpFHMHwDHRxr_wYk", NULL, '1.0', false);
    ...
    wp_enqueue_script("font-awesome-js", get_template_directory_uri().'/fontawesome/js/all.min.js',array(), false, false);
    wp_enqueue_script('main-university-js', get_theme_file_uri('/build/index.js'), array('jquery'), '1.0', false);
