...
class OurWordFilterPlugin {
    ...
    function ourSettings(){
        ...
        register_setting("replacementFields", "replacementText"); //register functtion in database
    ...
    function filterLogic($content){
        ...
        $badWords = explode(",", get_option(",", get_option("plugin_words_to_filter")));
    ...
    function ourMenu(){
        ...
        //20 x20 is a good icon height
       
        
        
        $mainPageHook = add_menu_page("Words To Filter","Word Filter","manage_options","ourwordfilter", array(
            $this,
            "wordFilterPage"
             ),
    ...
    function handleForm(){
       ...
       <?php }else{  ?>
        <div class="error">
        <p>Sorry, you do not have permission to perform that</p>
        </div>
    ...
    function wordFilterPage(){?>
        ...
        <div class="wrap">
            ...
            <form action="" method="post">
                ...
                <label for="plugin_words_to_filter"><p>Enter a <strong>comma separated</strong> list of words to filter from your site's contents</p></label>
